  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="facetedProductFilterApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="product-category" name="category" data-cy="category" label="Category" type="select" required>
                <option value="" key="0" />
                {categories
              ...
              <ValidatedField id="product-user" name="user" data-cy="user" label="User" type="select">
                <option value="" key="0" />
                {users
